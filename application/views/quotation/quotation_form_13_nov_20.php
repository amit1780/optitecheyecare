							...
							<?php if($quoteProductInfo){ ?>
								...
								?>								
									<tr class='prolist'>
										...
										<td ><input type="text" autocomplete="off" class="form-control proprs" id="proprs_<?php echo $productInfo['id']; ?>" name="price[]" value="<?php echo number_format((float)$withGstPrice, 2, '.', ''); ?>"/></td>
					...
					<div class="row"  >
						...
						<div class="col-sm-2">						  
						  <div class="form-group">							
							...
							<input type="text" name="price" value="" id="price" class="form-control" autocomplete='off' required>
