...
<div style="float:left;width:100%;border: 2px solid black;margin:0px;padding:0px;">	
	...
	<div style="float:left;border-top:2px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;padding-top: 7px;width:200px;"><b>RoDTEP : </b> <?php if($sliDetailInfo->rodtep == '1'){ echo "Yes"; }elseif($sliDetailInfo->rodtep == '0'){ echo "No"; }elseif($sliDetailInfo->rodtep == ''){ echo ""; } ?></div>
	</div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;width:70px;border-left:1px solid black;border-right:1px solid black;padding-top: 7px;/*background-color:#b3b3b3;*/"><?php if($challanInfo->account_number){ echo $challanInfo->account_number; }else{ echo $sliDetailInfo->sli_account_number; }  ?></div>		
		...
		<div style="float:left;width:146px;border-right:0px solid black;padding-top: 7px;"><b>Exporter Type (tick one)</b></div>		
		<div style="border-left:1px solid black;float:left;width:110px;border-right:1px solid black;padding-top: 7px;"><b>IEC No.</b></div>		
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;height:0px;">
		<div style="float:left;padding-top: 7px;width:75px;"><b>FedEx AWB No.</b></div>
		...
		<div style="float:left;width:65px;border-right:1px solid black;padding-top: 7px;">Manufacturer</div>
		<div style="float:left;width:40px;border-right:1px solid black;padding-top: 7px;"><?php if($sliDetailInfo->exporter_type == '1'){ echo $tick_img; } ?>&nbsp;</div>
		
		<div style="margin-left:39px;border-left:1px solid black;float:left;width:110px;border-right:1px solid black;padding-top: 7px;"><b>IEC Branch Serial No.</b></div>
		<div style="float:left;padding-top: 7px;/*background-color:#b3b3b3;*/">&nbsp;</div>
	</div>
	
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		<!-- <div style="float:left;padding-top: 7px;width:80px;"></div> -->
		<div style="float:left;width:144px;border-left:1px solid black;border-right:1px solid black;padding-top: 7px;/*background-color:#b3b3b3;*/"><?php if($challanInfo->docket_no){ echo $challanInfo->docket_no; } else { echo "&nbsp;"; } ?></div>		
		...
		<div style="margin-left:75px;float:left;width:65px;border-left:1px solid black;border-right:1px solid black;padding-top: 7px;">Merchant</div>
		<div style="float:left;width:40px;border-right:1px solid black;padding-top: 7px;"><?php if($sliDetailInfo->exporter_type == '2'){ echo $tick_img; } ?>&nbsp;</div>
		
		<div style="margin-left:39px;border-left:1px solid black;float:left;width:110px;border-right:1px solid black;padding-top: 7px;"><b>AD Code No.</b></div>		
		<div style="float:left;padding-top: 7px;"><?php echo $bankInfo->bank_ad_code;  ?></div>	
	</div>
	
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		<div style="float:left;padding-top: 10px;width:80px;"><b>Shipper</b></div>
		<div style="float:left;width:64px;border-left:1px solid black;border-right:1px solid black;padding-top: 0px;"><?php echo $challanInfo->store_shipper; ?></div>		
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		<div style="float:left;width:145px;height:103px;border-right:1px solid black;"><?php echo $challanInfo->store_address; ?><br>
		Email: operations@optitecheyecare.com
		</div>
		...
		<div style="float:left;width:118px;border-right:1px solid black;">
			...
			<div style="width:56px;float:left;padding-top:10px;border-right:1px solid black;border-bottom:1px solid black;"><?php echo $cost; ?></div>
			<div style="width:60px;float:left;text-align:right;padding-top:10px;"><b>Cost</b></div>
			<div style="width:56px;float:left;padding-top:10px;border-right:1px solid black;border-bottom:1px solid black;"><?php echo $freight_charges; ?></div>		
		...
		<div style="float:left;width:100px;border-right:0px solid black;">
			...
			<div style="width:56px;float:left;padding-top:10px;border-right:1px solid black;border-bottom:1px solid black;"><?php if($sliDetailInfo->incoterms == 'CIF') { echo $challan_total->net_total; }else{ echo "&nbsp;"; } ?></div>	
			
					
			<div style="width:56px;float:left;padding-top:10px;border-right:1px solid black;border-bottom:1px solid black;"><?php if($sliDetailInfo->incoterms == 'CIF') { echo $challan_total->freight_charges; }else{ echo "&nbsp;"; } ?></div>
			
			
		</div>
		
		<div style="float:left;width:70px;border-right:1px solid black;">
			<div style="border-left:1px solid black;border-bottom:1px solid black;">C& I-</div>
			<div style="width:60px;float:left;text-align:left;padding-top:10px;"><b>Cost</b></div>
			<div style="width:60px;float:left;text-align:left;padding-top:10px;"><b>Insurance</b></div>
		</div>	
		
		<div style="float:left;width:112px;border-right:0px solid black;">
			<div style="border-left:0px solid black;border-bottom:1px solid black;">&nbsp;</div>
			<div style="width:112px;float:left;text-align:left;padding-top:10px;border-bottom:1px solid black;">&nbsp;</div>
			<div style="width:112px;float:left;text-align:left;padding-top:10px;border-bottom:1px solid black;">&nbsp;</div>
		</div>
	</div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;height:0px;width:145px;border-right:1px solid black;border-top:0px solid black;height:118px;">
			<div style="float:left;"><b>Consignee</b> <br> <?php echo nl2br($challanInfo->shipping_details); ?>
				<?php if($customerInfo->gst){ ?>
					GST No.: <?php echo $customerInfo->gst; ?><br>
				<?php } ?>
				<?php if($customerInfo->company_registration_no){ ?>
					Reg. No.: <?php echo $customerInfo->company_registration_no; ?><br>
				<?php } ?>
				<?php if($customerInfo->drug_licence_no){ ?>
					Drug Licence no.: <?php echo $customerInfo->drug_licence_no; ?>
				<?php } ?>
			</div>
		</div>
		...
		<div style="float:left;border-top:0px solid black;height:118px;">
			...
			<div style="float:left;width:51px;border-left:0px solid black;border-right:1px solid black;padding-top: 20px;height:80px;/*background-color:#b3b3b3;*/">&nbsp;&nbsp;<?php echo $tick_img; ?></div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;padding-top: 4px;width:210px;text-align:center;border-right:1px solid black;"><b>GSTN NO-</b>09ACBPJO823B1ZA</div>		
		...
		<div style="float:left;padding-top: 4px;text-align:center;/*background-color:#b3b3b3;*/">&nbsp;&nbsp; GNX-200</div>	
	</div>
	
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		<div style="float:left;padding-top: 4px;width:75px;"><b>Email ID- </b></div>
		<div style="float:left;width:70px;border-left:1px solid black;border-right:1px solid black;padding-top: 4px;/*background-color:#b3b3b3;*/">&nbsp;</div>		
		<div style="float:left;padding-top: 4px;width:210px;text-align:center;border-right:1px solid black;"><b>GSTIN State Code -</b>09</div>		
		<div style="float:left;padding-top: 4px;width:110px;text-align:center;border-right:1px solid black;/*background-color:#b3b3b3;*/">&nbsp;</div>		
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;padding-top: 4px;width:210px;text-align:center;border-right:1px solid black;"><b>Payment Type -</b><?php echo $challanInfo->payment_terms; ?></div>		
		<div style="float:left;padding-top: 4px;width:55px;text-align:center;border-right:1px solid black;">LUT</div>		
		<div style="float:left;padding-top: 4px;width:55px;text-align:center;border-right:1px solid black;/*background-color:#b3b3b3;*/">&nbsp;<?php if($sliDetailInfo->lut == '1'){ echo $tick_img; } ?></div>		
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:9px;">
		...
		<div style="float:left;border-left:1px solid black;border-right:1px solid black;width:250px;">Post shipment document  delivery email Id</div>		
		<div style="float:left;"><?php if($sliDetailInfo->document_delivery_email) { echo $sliDetailInfo->document_delivery_email; } else { echo "&nbsp;"; } ?></div>		
	</div>
	...
	<div style="float:left;border-right:0px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;">
			...
			<?php if($sliDetailInfo->customs_broker){ echo nl2br($sliDetailInfo->customs_broker); } else { echo "&nbsp;"; } ?>
		
			<!-- <div style="float:left;width:110px;border-right:0px solid black;">Contact person</div>				
			<div style="float:left;border-left:1px solid black;border-right:0px solid black;border-top:1px solid black;/*background-color:#b3b3b3;*/"><?php if($sliDetailInfo->post_contact_person){ echo $sliDetailInfo->post_contact_person; }  ?></div>
			
			<div style="float:left;width:110px;border-right:0px solid black;">Telephone / Mobile</div>				
			<div style="float:left;border-left:1px solid black;border-right:0px solid black;border-top:1px solid black;/*background-color:#b3b3b3;*/"><?php if($sliDetailInfo->post_mobile){ echo $sliDetailInfo->post_mobile; }  ?></div>
			
			<div style="float:left;width:110px;border-right:0px solid black;">Street Address 1</div>				
			<div style="float:left;border-left:1px solid black;border-right:0px solid black;border-top:1px solid black;/*background-color:#b3b3b3;*/">8/8, Strachy Road Civil Lines</div>
			
			<div style="float:left;width:110px;border-right:0px solid black;">&nbsp;</div>				
			<div style="float:left;border-left:1px solid black;border-right:0px solid black;border-top:1px solid black;/*background-color:#b3b3b3;*/">Allahabad(Prayagraj)</div>
			...
			<div style="float:left;border-left:1px solid black;border-right:0px solid black;border-top:1px solid black;/*background-color:#b3b3b3;*/">211001</div>
