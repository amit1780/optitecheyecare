			...
			<div class="row quote_view borderbox">
				...
				<table class="table-sm table-bordered" width="100%" cellspacing="0">
					<tr>
						...
						<th class="border_right" style="width:7%;text-align:center;">HSN<?php if($quotationInfo->currency == 'INR'){ echo '-GST'; ?><?php } ?></th>
						<?php if(($quotationInfo->currency == 'INR') && ($quotationInfo->quote_id > 1343)){ ?>
					...
					?>
							...
							<tr>
								...
								<td align="center" class="border_right border_top"><?php echo $productInfo['hsn']; ?><?php if($quotationInfo->currency == 'INR'){ echo '<br>'.$productInfo['product_gst']; ?> %<?php } ?></td>
								<?php if(($quotationInfo->currency == 'INR') && ($quotationInfo->quote_id > 1343)){ ?>
								...
								<td align="center" class="border_right border_top"><?php echo number_format((float)$productInfo['rate'], 4, '.', ''); ?></td>
								<td align="center" class="border_right border_top"><?php echo number_format((float)$productInfo['discount'], 4, '.', ''); ?></td>
								<td class="border_top" align="right"><?php echo number_format((float)$productInfo['net_amount'], 2, '.', ''); ?></td>
							</tr>
					
					<?php $i++; } ?>					
					<tr>
						<td class="border_right border_top" colspan="<?php if($quotationInfo->currency == 'INR' && $quotationInfo->quote_id > 1343){ echo '8'; } else { echo '7'; } ?>" align="right" ><b>Net Total</b></td>
						<td class="border_right border_top" align="right"> <i class="<?php echo $quotationInfo->currency_faclass; ?>" style="font-size:13px;"></i>&nbsp; <?php echo number_format((float)$net_total, 2, '.', ''); ?></td>
					</tr>
					<tr>
						<td class="border_right border_top" colspan="<?php if($quotationInfo->currency == 'INR' && $quotationInfo->quote_id > 1343){ echo '8'; } else { echo '7'; } ?>" align="right" ><b>Freight Charges</b></td>
						<td class="border_right border_top" align="right"> <i class="<?php echo $quotationInfo->currency_faclass; ?>" style="font-size:13px;"></i>&nbsp; <?php echo number_format((float)$quotationInfo->freight_charge, 2, '.', ''); ?></td>
					</tr>
							<?php
							...
							<tr>
								<td class="border_right border_top" colspan="<?php if($quotationInfo->currency == 'INR' && $quotationInfo->quote_id > 1343){ echo '8'; } else { echo '7'; } ?>" align="right" ><b>GST @ <?php echo $progst['product_gst']; ?>%</b></td>
					...
					<?php } ?>
					<tr>
						<td class="border_right border_top" colspan="<?php if($quotationInfo->currency == 'INR' && $quotationInfo->quote_id > 1343){ echo '8'; } else { echo '7'; } ?>" align="right" ><b>Grand Total</b></td>
						<td class="border_right border_top" align="right"> <b><i class="<?php echo $quotationInfo->currency_faclass; ?>" style="font-size:13px;"></i>&nbsp; <?php echo number_format((float)($net_total + $quotationInfo->freight_charge + $totwithgst), 2, '.', ''); ?></b></td>
					</tr>
				</table>
			</div>
			<br>
