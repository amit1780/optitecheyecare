...
<div style="float:left;width:100%;border: 2px solid black;margin:0px;padding:0px;">	
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;width:75px;border-right:1px solid black;padding-top: 7px;background-color:#b3b3b3;">&nbsp;</div>	
		...
		<div style="float:left;border-right:0px solid black;padding-top: 7px;background-color:#b3b3b3;">&nbsp;</div>	
	</div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;height:0px;">
		...
		<div style="margin-left:50px;float:left;width:75px;border-left:1px solid black;border-right:1px solid black;padding-top: 7px;background-color:#b3b3b3;">&nbsp;</div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;width:64px;border-left:1px solid black;border-right:1px solid black;padding-top: 7px;background-color:#b3b3b3;">&nbsp;</div>		
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;padding-top: 10px;background-color:#b3b3b3;">&nbsp;</div>	
	</div>
	
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		<div style="float:left;width:145px;height:103px;border-right:1px solid black;">&nbsp;</div>
		...
		<div style="float:left;width:75px;border-right:1px solid black;">
			...
			<div style="text-align:right;padding-top: 15px;background-color:#b3b3b3;margin-top: 0px;border-top:1px solid black;">&nbsp;</div>
		</div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;width:50px;border-left:1px solid black;border-right:1px solid black;padding-top: 6px;background-color:#b3b3b3;">&nbsp;</div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;width:70px;border-left:1px solid black;border-right:1px solid black;padding-top: 6px;background-color:#b3b3b3;">&nbsp;</div>		
		<div style="float:left;width:90px;padding-top: 6px;"><b>Non Drawback</b></div>
		<div style="float:left;width:50px;border-left:1px solid black;border-right:1px solid black;padding-top: 6px;background-color:#b3b3b3;">&nbsp;</div>
		<div style="float:left;width:63px;border-left:0px solid black;border-right:1px solid black;padding-top: 6px;">&nbsp;</div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		<div style="float:left;width:145px;height:65px;border-right:1px solid black;">Consignee</div>
		<div style="float:left;width:90px;padding-top: 20px;font-size:8px;text-align:center;border-right:1px solid black;height:45px;">Advance Authorization (AA)</div>
		<div style="float:left;width:50px;padding-top: 20px;font-size:8px;text-align:center;border-right:1px solid black;height:45px;background-color:#b3b3b3;">&nbsp;</div>
		<div style="float:left;width:63px;border-left:0px solid black;border-right:1px solid black;padding-top: 20px;height:45px;">&nbsp;</div>
		<div style="float:left;width:65px;border-left:0px solid black;border-right:1px solid black;padding-top: 20px;height:45px;">Re-Export</div>
		<div style="float:left;width:51px;border-left:0px solid black;border-right:1px solid black;padding-top: 20px;height:45px;background-color:#b3b3b3;">&nbsp;</div>
		<div style="float:left;width:51px;border-left:0px solid black;border-right:1px solid black;padding-top: 20px;height:45px;">&nbsp;</div>
		<div style="float:left;width:59px;border-left:0px solid black;border-right:1px solid black;padding-top: 20px;height:45px;">MEIS (REWARD)</div>
		<div style="float:left;width:51px;border-left:0px solid black;border-right:1px solid black;padding-top: 20px;height:45px;background-color:#b3b3b3;">&nbsp;</div>
		<div style="float:left;border-left:0px solid black;border-right:0px solid black;padding-top: 0px;height:60px;font-size:8px;"><b>If MEIS box is ticked in type of shippping bill please mention on the Shipping Bill as under: "We intend to claim rewards under Merchandise Export From India Scheme (MEIS)"</b></div>		
	</div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;padding-top: 4px;background-color:#b3b3b3;">&nbsp;</div>		
	</div>
	...
	<div style="float:left;border-top:0px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;padding-top: 4px;background-color:#b3b3b3;border-top:1px solid black;width:200px;">&nbsp;</div>		
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;background-color:#b3b3b3;">
		...
		<div style="float:left;width:65px;border-left:1px solid black;border-right:1px solid black;height:45px;">&nbsp;</div>		
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;background-color:#b3b3b3;">
		<div style="float:left;width:80px;height:43px;">&nbsp;</div>
		<div style="float:left;width:65px;border-left:1px solid black;border-right:1px solid black;height:43px;">&nbsp;</div>		
