...
<html lang="en">
  <head>
    ...
    <link href ="<?php echo base_url(); ?>assets/js/jquery-confirm.min.css" rel="stylesheet">
  ...
  <body id="page-top">      
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
	 <?php if($this->session->userdata('group_type') != 'EMP'){ ?>
      <a class="navbar-brand mr-1" href="<?php echo site_url('dashboardtwo'); ?>">Optitech Eye Care</a>
	 <?php } else { ?>
      ...
      <ul class="sidebar navbar-nav">
		...
		<li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown">	
			    ...
			    <a class="dropdown-item" href="<?php echo site_url('quotation');?>">Quoation in Process</a>			   
				<a class="dropdown-item" href="<?php echo site_url('genQuote');?>"> Quoation Generate</a>
				<a class="dropdown-item" href="<?php echo site_url('orderList');?>">Orders</a>
				<a class="dropdown-item" href="<?php echo site_url('challanList');?>">Challans</a> -->
				
				 <a class="dropdown-item" href="<?php echo site_url('quotation');?>">Quoation List</a>
			    <a class="dropdown-item" href="<?php echo site_url('quoteComplete');?>">Quoation History</a>
				<a class="dropdown-item" href="<?php echo site_url('genQuote');?>">Generate Quoation</a>
		...
		<li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown">				
				...
				<?php if(($this->session->userdata('user_id') == '1') || ($this->session->userdata('user_id') == '2') || ($this->session->userdata('user_id') == '7') || ($this->session->userdata('user_id') == '13') || ($this->session->userdata('user_id') == '4') || ($this->session->userdata('user_id') == '14')){ ?>
		...
		<li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown">	
				<a class="dropdown-item" href="<?php echo site_url('stockPending');?>">Pending Stock</a>
				<a class="dropdown-item" href="<?php echo site_url('stock');?>">Stock List</a>
				<?php if($this->session->userdata('group_type')=='SADMIN' || in_array($this->session->userdata('username'),$this->config->item('STOCKADD'))){ ?>
		...
		<li class="nav-item dropdown">
		  <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			<i class="fas fa-fw fa-chart-area"></i>
			<span>Manage Carrier</span></a>			
			<div class="dropdown-menu" aria-labelledby="pagesDropdown">	
				<a class="dropdown-item" href="<?php echo site_url('sli');?>">Carrier List</a>							
			</div>
		</li>
		...
		<li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown">				
				...
				<a class="dropdown-item" href="<?php echo site_url('search');?>" >Advance Search</a>
			</div>
        </li>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					...
					<a class="dropdown-item" href="<?php echo site_url('userList');?>" >User List</a>
					<a class="dropdown-item" href="<?php echo site_url('addUser');?>" >Add User</a>
					<a class="dropdown-item" href="<?php echo site_url('packerList');?>" >Packer List</a>
					<a class="dropdown-item" href="<?php echo site_url('packer');?>" >Add Packer</a>
		...
		<li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Manage Complaint</span></a>			
			<div class="dropdown-menu" aria-labelledby="pagesDropdown">
				<a class="dropdown-item" href="<?php echo site_url('complaint');?>" >Complaint List</a>
				<a class="dropdown-item" href="<?php echo site_url('addComplaint');?>">Add Complaint</a>
			</div>
        </li>
         ...
         <!-- <?php if(($this->session->userdata('group_type') == 'SADMIN')){ ?>
			<li class="nav-item dropdown">
			  <a class="nav-link dropdown-toggle" href="" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<span>Setting</span></a>			
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					<a class="dropdown-item" href="<?php echo site_url('setting');?>">Setting</a>
				</div>
			</li>
		<?php } ?> -->	
      </ul>
