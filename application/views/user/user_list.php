			...
			<div class="col-sm-6">				
			 ...
			 <div class="col-sm-6">
				<div class="float-right">
					<a href="<?php echo site_url('addUser'); ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Add User"> <i class="fas fa-plus"></i></a>
				</div>
			</div> 	
		</div>		
	</div>
				...
				<?php foreach($users as $user){ ?>
					  ...
					  <tr>
						...
						<td class="text-center">
						    <a href="<?php echo site_url('editUser'); ?>/<?php echo $user['user_id']; ?>"  title="View" ><i class="fas fa-edit"></i></a>&nbsp;&nbsp;
						    <!-- <a href="<?php echo site_url('viewUser'); ?>/<?php echo $user['user_id']; ?>"  title="View" ><i class="fas fa-eye"></i></a> -->
						</td>
					  </tr>
				<?php } ?>  
			<?php } ?>  
