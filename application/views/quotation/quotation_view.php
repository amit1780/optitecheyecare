			...
			<div class="col-sm-6">
				...
				<?php if($quotationInfo->is_deleted == 'N'){ ?>
					...
					<?php } ?>					
						...
						<a target="_blank" href="<?php echo site_url('quotation/quotePrint'); ?>?quotation_id=<?php echo $quotationInfo->quote_id; ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Print"> <i class="fas fa-print"></i></a> &nbsp;
