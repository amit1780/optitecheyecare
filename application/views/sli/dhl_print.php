...
<div id="printableArea" style="padding-right: 75px;padding-left: 75px;padding-top: 30px;margin-right: auto;margin-left: auto; font-size:14px;">	
	<div style="border: 1px solid black;display:flex;flex-wrap: wrap;">
			...
			<div style="border-bottom:1px solid black;width: 100%;height: 14px;font-size: 9px;">
				...
				<div style="width:34%;float:left;text-align:center;height: 14px;"><?php echo $invoice_date; ?> | <b>RoDTEP : </b> <?php if($sliDetailInfo->rodtep == '1'){ echo "Yes"; }elseif($sliDetailInfo->rodtep == '0'){ echo "No"; }elseif($sliDetailInfo->rodtep == ''){ echo ""; } ?></div>
			</div>
			<div style="border-bottom:1px solid black;width: 100%;height: 14px;font-size: 9px;">
			...
			<div style="border-bottom:1px solid black;width: 100%;height: 14px;font-size: 9px;">
				<b>DHL AWB No.#</b>&nbsp;&nbsp;&nbsp;<?php echo $challanInfo->docket_no; ?>&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; DHL Account No.# &nbsp;&nbsp;&nbsp; <?php if($challanInfo->account_number){ echo $challanInfo->account_number; }else{ echo $sliDetailInfo->sli_account_number; }  ?>
			</div>			
