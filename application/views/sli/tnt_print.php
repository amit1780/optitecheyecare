...
<div style="float:left;width:100%;border: 2px solid black;margin:0px;padding:0px;">	
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		<div style="float:left;padding-top: 7px;width:75px;"><b>TNT A/c No.</b></div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;height:0px;">
		<div style="float:left;padding-top: 7px;width:75px;"><b>TNT AWB No.</b></div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		...
		Email: operations@optitecheyecare.com</div>
	...
	<div style="float:left;border-top:1px solid black;width: 100%;font-size:8px;">
		<div style="float:left;width:145px;border-right:1px solid black;height:51px;">
			<div style="">Tel No. - <?php if($sliDetailInfo->tel_number) { echo $sliDetailInfo->tel_number; } else { echo "&nbsp;"; } ?> </div>
			<div style="padding-top: 20px;">Email ID - <?php if($sliDetailInfo->email_id) { echo $sliDetailInfo->email_id; } else { echo "&nbsp;"; } ?> </div>
		</div>
		<!-- <div style="float:left;width:70px;border-left:1px solid black;border-right:1px solid black;padding-top: 40px;">
			<div style=""><?php if($sliDetailInfo->tel_number) { echo $sliDetailInfo->tel_number; } else { echo "&nbsp;"; } ?></div>
			<div style="padding-top: 20px;"><?php if($sliDetailInfo->email_id) { echo $sliDetailInfo->email_id; } else { echo "&nbsp;"; } ?></div>		
		</div> -->		
	...
	<div style="float:left;border-right:0px solid black;width: 100%;font-size:8px;">
		...
		<div style="float:left;">
			...
			<div style="float:left;border-left:1px solid black;border-right:0px solid black;border-top:1px solid black;/*background-color:#b3b3b3;*/"><?php if($sliDetailInfo->post_contact_person){ echo $sliDetailInfo->post_contact_person; } else { echo "Ms. Neelam"; } ?></div>
			
			<div style="float:left;width:110px;border-right:0px solid black;">Telephone / Mobile</div>				
			<div style="float:left;border-left:1px solid black;border-right:0px solid black;border-top:1px solid black;/*background-color:#b3b3b3;*/"><?php if($sliDetailInfo->post_mobile){ echo $sliDetailInfo->post_mobile; } else { echo "+91 8176080204"; } ?></div>
