...
class Challan extends CI_Controller {
	...
	<div style="width:64%;float:left;font-size:15px;text-align:left;">DISPATCH CHALLAN From</div>
	<div style="float:right;"><b style="font-size:18px;">'. str_pad($data['ordersInfo']->quotation_id, 7, "Q-00000", STR_PAD_LEFT) .' / '.str_pad($data['challanInfo']->order_id, 7, "O-00000", STR_PAD_LEFT).' / '. str_pad($challan_id, 7, "C-00000", STR_PAD_LEFT).'</b></div>
</div>';
	...
	<div style="width:64%;float:left;font-size:15px;text-align:left;">DISPATCH NOTE</div>
	...
	public function printSli() {
		...
		$data['sliDocInfo'] = $this->challan_model->getSliDocByID($sli_id,$data['sli_detail_info']->sli_detail_id);
